...
def fixDelex(filename, data, _, idx, idx_acts):
    ...
    #     return data
    # print(data['log'][idx])
    if 'dialog_act' in data['log'][idx]:
        turn = data['log'][idx]['dialog_act']
    else:
        return data
...
def createDelexData():
    ...
    for dialogue_name in tqdm(data):
        ...
        for idx, turn in enumerate(dialogue['log']):
            ...
            dialogue = fixDelex(dialogue_name, dialogue, None, idx, idx_acts)
            idx_acts += 1
